...
import {BancosCardComponent} from '../components/bancos/bancos-card/bancos-card';
...
import {ClienteActionToolBarComponent} from '../components/clientes/cliente-action-tool-bar/cliente-action-tool-bar';
import {ClienteCtaCteCardComponent} from '../components/clientes/cliente-cta-cte-card/cliente-cta-cte-card';
import {ClienteListItemContentComponent} from '../components/clientes/cliente-list-item-content/cliente-list-item-content';
import {ColoresFindAndSelectComponent} from '../components/comunes/colores-find-and-select/colores-find-and-select';
...
import {FormBadgeInputItemComponent} from '../components/comunes/form-badge-input-item/form-badge-input-item';
import {FormBadgeItemComponent} from '../components/comunes/form-badge-item/form-badge-item';
import {CajaMovimientosCardComponent} from '../components/fondos/caja-movimientos-card/caja-movimientos-card';
import {ChequesEnCarteraCardComponent} from '../components/fondos/cheques-en-cartera-card/cheques-en-cartera-card';
...
@NgModule({
  ...
  providers: [
    ...
    DescuentosProvider, CtasCtesProvider, BancosProvider, PagosProvider,
    ContadoresProvider, LogProvider, FondosProvider
  ]
})
